...
- Calibration targets evolve: the SAFE BOTs Act is a bill, not a law; Tennessee's impersonation statute takes effect 7/1/2026; California's chatbot law is in effect; Vermont's H.816 therapy-bot ban was signed June 17, 2026 and is the clearest "AI cannot be the therapist" statute to date; companion therapy-bot bans are advancing in additional states (e.g., a Rhode Island therapy-bot ban passed both chambers in June 2026, not yet signed); AMA recommendations are voluntary. The skill reports each on its current legal status in the Jurisdictional Mapping and flags any change-in-status since the last review.
