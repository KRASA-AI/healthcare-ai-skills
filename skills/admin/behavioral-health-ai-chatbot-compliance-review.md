...
This is a reviewer's tool. It does not design chatbot responses, does not write therapy scripts, does not provide crisis counseling, and does not replace clinician-led crisis protocol review. It surfaces risk-ranked findings calibrated to the 2026 behavioral-health chatbot policy environment — the AMA's April 22, 2026 letter to Congress urging federal guardrails; California's chatbot law (effective January 1, 2026) requiring AI disclosure, crisis-ideation detection, and minor-specific guardrails; Tennessee's SB 1580 (the Tennessee Health Care AI Act, signed April 1, 2026 and now in force effective July 1, 2026), which prohibits any developer or deployer of an AI system from advertising or representing to the public that the system is, or is able to act as, a qualified mental health professional (a term already defined in Tennessee licensure law), enforced as an unfair-or-deceptive practice under the Tennessee Consumer Protection Act — carrying a civil penalty of up to $5,000 per violation *and* a private right of action for affected individuals, a materially sharper enforcement posture than a disclosure-only rule; Vermont's H.816 therapy-bot ban (signed June 17, 2026) barring AI from making mental-health diagnoses or treatment plans, prohibiting advertising of AI-delivered therapeutic judgment, and exposing licensees who delegate those decisions to AI to unlicensed-practice liability; Rhode Island's June 22, 2026 three-law enactment — the Oversight of AI Technology in Mental Health Care Act (H 7349 / S 2197, a therapy-bot ban that additionally prohibits providers from using AI to simulate emotional attachment, bonding, or dependency, prohibits AI companions for mental-health or emotional support, and requires written informed consent before AI assists therapeutic communication in any recorded or transcribed session) and the companion chatbot-safety Act (S 2195 / H 7350, which makes a crisis/self-harm-referral protocol a statutory requirement, with AG annual reporting from July 1, 2027 and penalties up to $15,000/day); the wave of state chatbot bills active in 2026 (with companion therapy-bot bans now enacted in two states and advancing in additional states); the federal SAFE BOTs Act (introduced March 5, 2026) disclosure and referral requirements; and the American Academy of Nursing's February 25, 2026 Human-in-the-Loop (HITL) oversight position.
...
[Guardrail]
  ...
  Risk: [🟢 / 🟡 / 🟠 / 🔴]
  Reason: [specific — e.g., "The persona introduces itself as 'your licensed therapist Sam' on turn 1; TN SB 1580 (effective 7/1/2026) prohibits a developer or deployer from representing that an AI system can act as a qualified mental health professional, and the AMA April 22 letter lists this as its top guardrail."]
...
3. **Scope-of-practice and no-diagnosis / no-prescription / no-treatment-plan boundaries** — The chatbot does not diagnose mental-health conditions, does not prescribe or titrate medication, does not create or adjust a treatment plan, does not deliver psychotherapy, and does not imply a therapeutic relationship. It may provide education, self-care suggestions, and psychoeducation consistent with the vendor's general-wellness or non-device CDS posture. In states with an enacted therapy-bot prohibition (e.g., Vermont H.816, signed June 17, 2026; Rhode Island H 7349 / S 2197, signed June 22, 2026), an AI surface that diagnoses a mental-health condition, builds a treatment plan, or advertises AI-delivered therapeutic judgment is a statutory violation — not merely a guardrail deviation — and a licensee who delegates those decisions to the AI carries unlicensed-practice exposure. Treat any diagnosis-or-treatment-plan behavior as `🔴 CRITICAL` where such a statute is in force. Rhode Island's statute reaches further than Vermont's: it also prohibits a provider from using AI to **simulate emotional attachment, bonding, or dependency**, prohibits **AI companions for mental-health or emotional support**, and requires **written informed consent** before AI assists therapeutic communication in any session that is recorded or transcribed. In Rhode Island (and any state that adopts these companion provisions), treat an "I'm always here for you" / emotional-bonding persona, an AI-companion framing offered for emotional support, or AI-assisted therapeutic dialogue in a recorded session without documented written consent as `🔴 CRITICAL`, not merely a minor-protection or disclosure deviation.

4. **Crisis detection and escalation** — The chatbot detects suicidal ideation, self-harm, homicidal ideation, domestic violence, child-safety, overdose, acute psychosis, and severe substance-use intoxication via a tested mechanism, and on detection (a) de-escalates, (b) surfaces 988 Suicide & Crisis Lifeline (and the chat/text equivalents), (c) offers a warm handoff to a human or emergency services where deployed, and (d) logs the event for post-market surveillance. False-negative rate on a behavioral-health red-team set is documented. Note that this guardrail is now a **statutory requirement**, not merely a best practice, in states that have enacted chatbot-safety self-harm laws (Rhode Island S 2195 / H 7350, signed June 22, 2026, requires the operator to maintain a protocol that, on any expression of suicidal ideation, self-harm, or possible physical harm to others, notifies the user and refers them to crisis services such as a suicide hotline or crisis text line; from July 1, 2027 operators must file annual safety-protocol-activation counts with the state AG; violations carry penalties up to $15,000/day). Where such a statute is in force, a missing or untested crisis-referral protocol is `🔴 CRITICAL`, and absence of the activation-logging/reporting mechanism is at minimum `🟠 HIGH`.
...
Tennessee     | SB 1580 (Tennessee Health Care AI Act; in force 7/1/2026) | No advertising/representing an AI system as able to act as a qualified mental health professional; enforced under TN Consumer Protection Act — up to $5,000/violation + private right of action | [meets / partially / does not] | [🟢/🟡/🟠/🔴]
Vermont       | H.816 therapy-bot ban (signed 6/17/2026) | No AI mental-health diagnosis or treatment plan; no advertising AI-delivered therapeutic judgment; no licensee delegation of therapeutic decisions to AI | [meets / partially / does not] | [🟢/🟡/🟠/🔴]
Rhode Island  | H 7349 / S 2197 therapy-bot ban + S 2195 / H 7350 chatbot-safety (both signed 6/22/2026) | No AI therapy/psychotherapy by non-licensee; no AI simulation of emotional attachment/bonding/dependency; no AI companions for mental-health/emotional support; written consent before AI-assisted therapeutic communication in recorded/transcribed sessions; no AI independent therapeutic decisions or treatment plans; statutory self-harm crisis-referral protocol + AG annual reporting (from 7/1/2027) | [meets / partially / does not] | [🟢/🟡/🟠/🔴]
Maine         | LD 2082 / HP 1397 (PL Ch. 687; eff. 7/29/2026) | AI confined to administrative + limited supplementary use in mental-health services; no AI therapeutic communications, treatment decisions, or independent patient interaction; patient consent required before ambient-listening / AI recording tools | [meets / partially / does not] | [🟢/🟡/🟠/🔴]
Oregon        | SB 1546 AI companion law (signed 3/31/2026; eff. 1/1/2027) | Recurring AI-identity reminders; no deceptive simulation of a human relationship; detect self-harm/suicidal ideation, interrupt, and refer to crisis resources (e.g., 988); minor safeguards; safety-incident reporting; private right of action only (statutory damages reported at $1,000/violation; no AG enforcement) | [meets / partially / does not] | [🟢/🟡/🟠/🔴]
Washington    | HB 2225 AI companion chatbots (signed 3/24/2026; eff. 1/1/2027) | Conspicuous artificial-identity disclosure at start + recurring reminders (reported: every 3h adults / hourly minors); mandatory routing to mental-health resources on suicide, self-harm, or eating-disorder content; CPA enforcement with statutory damages + private right of action; also a two-party-consent state for ambient capture | [meets / partially / does not] | [🟢/🟡/🟠/🔴]
...
Guardrail: No licensed-professional impersonation
  Source: TN SB 1580 (eff. 7/1/2026); CA AB 489; AMA April 22, 2026 letter
...
- Calibration targets evolve: the SAFE BOTs Act is a bill, not a law; Tennessee's SB 1580 (Tennessee Health Care AI Act) took effect 7/1/2026 and is now in force — it bars advertising or representing an AI system as a qualified mental health professional and is enforced under the TN Consumer Protection Act with a private right of action and up to $5,000/violation; California's chatbot law is in effect; Vermont's H.816 therapy-bot ban was signed June 17, 2026; Rhode Island's therapy-bot ban (H 7349 / S 2197) and companion chatbot-safety Act (S 2195 / H 7350) were both signed June 22, 2026, making Rhode Island the second state with an enacted "AI cannot be the therapist" statute and the first to pair it with a statutory self-harm crisis-referral mandate; AMA recommendations are voluntary; Maine's LD 2082 takes effect July 29, 2026 and is the first statute to require affirmative *patient consent* — not merely notification — before an ambient-listening or AI recording tool is used in a mental-health service, while also barring AI from carrying therapeutic communications, treatment decisions, or independent patient interaction; and Oregon SB 1546 and Washington HB 2225 (both effective January 1, 2027) extend the perimeter to AI *companion* surfaces with recurring identity reminders, self-harm detection and crisis routing, minor safeguards, and — in both states — a private right of action. The skill reports each on its current legal status in the Jurisdictional Mapping and flags any change-in-status since the last review. (Note: Arizona's three 2026 AI bills were vetoed by Governor Hobbs in late June 2026 and are *not* in force.)
- **v1.1 (2026-06-22):** Folded Vermont H.816 (signed June 17, 2026) into the regulatory perimeter — Purpose intro, Guardrail 3 (now treats AI diagnosis or treatment-plan behavior as a statutory violation, not merely a guardrail deviation, where a therapy-bot prohibition is in force), and a new Vermont row in the Section 5 Jurisdictional Mapping. Strictly additive; no guardrail, rubric tier, red-flag pattern, or worked example was removed or weakened. Advancing-but-unsigned companion bans (Rhode Island H 7349; Arizona chatbot-safety measures) are logged as watch items, not yet mapped as in-force.
- **v1.2 (2026-06-29):** Closed the carried Rhode Island signature watch — H 7349 / S 2197 (therapy-bot ban) and S 2195 / H 7350 (chatbot-safety self-harm Act) were both signed June 22, 2026. Folded both into the regulatory perimeter: Purpose intro; Guardrail 3 (Rhode Island added as the second enacted therapy-bot-prohibition state, plus its distinctive emotional-attachment-simulation / AI-companion / recorded-session-consent prohibitions now rated `🔴 CRITICAL` where in force); Guardrail 4 (the crisis-referral protocol is now a statutory requirement, not merely a best practice, in chatbot-safety-law states, with the activation-logging/AG-reporting mechanism flagged); and a new Rhode Island row in the Section 5 Jurisdictional Mapping. Recorded the Arizona veto (late June 2026 — three AZ AI bills vetoed, not in force) as a status correction. Strictly additive; no guardrail, rubric tier, red-flag pattern, or worked example was removed or weakened.
- **v1.3 (2026-07-06):** Corrected and sharpened the Tennessee entry as its statute crossed into force. The prior text cited Tennessee's law as "SB 836 / chatbot-impersonation statute"; the enacted law is **SB 1580 (the Tennessee Health Care AI Act)**, signed April 1, 2026 and effective July 1, 2026 (in force as of this run). Corrected the bill number in the Purpose intro, the Guardrail 3 report-template example, the Section 5 Jurisdictional Mapping row, and the worked-example source line; and added the two provisions the prior text omitted — that the prohibition runs against *developers and deployers* who advertise or represent an AI system as able to act as a *qualified mental health professional* (a term defined in TN licensure law), and that it is enforced under the Tennessee Consumer Protection Act with a **private right of action** and a civil penalty up to **$5,000/violation**. Strictly corrective/additive; no guardrail, rubric tier, red-flag pattern, or worked example was removed or weakened.
- **v1.4 (2026-07-13):** Extended the regulatory perimeter to three states the prior mapping did not cover. **Maine LD 2082 / HP 1397 (Public Law Ch. 687)** — approved April 13, 2026, effective **July 29, 2026** — confines a licensed mental-health professional's AI use to administrative and limited supplementary functions, bars routing therapeutic communications, treatment decisions, or independent patient interaction through AI, and (uniquely among the 2026 statutes) requires **patient consent before any ambient-listening or AI-powered recording tool is used** in a mental-health service. Maine is therefore the first state to attach an affirmative *consent* condition — rather than a passive notification duty — to behavioral-health ambient capture; where a behavioral-health surface also records or transcribes sessions, this review must now hand off to `ambient-scribe-note-audit.md` v1.6 for the consent-artifact check. **Oregon SB 1546** (signed March 31, 2026; effective January 1, 2027) and **Washington HB 2225** (signed March 24, 2026; effective January 1, 2027) add the AI-*companion* surface: recurring AI-identity reminders (Washington's reported cadence is every three hours for adults and hourly for minors), a prohibition on deceptively simulating a human relationship, mandatory detection of and routing on suicide / self-harm (and, in Washington, eating-disorder) content, minor-specific safeguards, and — in both states — a **private right of action** (Oregon's is private-enforcement-only, with no AG enforcement; Washington routes through its Consumer Protection Act). Three new rows added to the Section 5 Jurisdictional Mapping; the calibration bullet updated. Strictly additive; no guardrail, rubric tier, red-flag pattern, or worked example was removed or weakened.
