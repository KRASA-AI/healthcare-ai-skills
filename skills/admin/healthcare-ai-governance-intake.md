...
Produce a structured, auditable governance-intake record for any AI tool a health system, medical group, or community clinic is evaluating, piloting, expanding, renewing, or decommissioning — scored against an eight-pillar control framework aligned with the May 27, 2026 Coalition for Health AI (CHAI) governance playbook architecture, the Joint Commission Responsible Use of AI in Healthcare (RUAIH) certification launched June 1, 2026 (five certification standard areas — see the RUAIH crosswalk in Section 3), the NIST AI Risk Management Framework, ISO 42001, the HHS AI Strategy (April 3, 2026 risk-management deadline), and the operative state and federal AI-in-healthcare regulatory perimeter. Output is designed for AI governance committees, AI Use Officers, CMIO / CNIO / CCIO offices, vendor-management offices, IT security and privacy teams running an AI-aware HIPAA risk analysis under 45 CFR §164.308(a)(1)(ii)(A), CDI and informatics leaders, medical-staff committees reviewing pilot-to-enterprise expansion, board AI subcommittees responding to the federal moratorium-dead environment, and community-health and safety-net clinics that need a resource-scaled intake pattern rather than the AMC-default deep-stack review.
...
- **Joint Commission RUAIH certification preparation.** The Joint Commission Responsible Use of AI in Healthcare (RUAIH) certification — launched June 1, 2026, the first certification designed exclusively for healthcare organizations and built on the CHAI playbook architecture — requires the deployer to demonstrate governance, safeguards, monitoring, and education across five certification standard areas (governance; effective data management; risk and bias reduction; monitoring/evaluating/validating safety, effectiveness, and responsible use; transparency, education, and training). The certification certifies the *organization's* responsible-use posture, not individual AI products, and an applicant does not need to be Joint Commission-accredited to apply. This skill produces the per-tool intake record that aggregates into the organization-level evidence RUAIH surveyors examine; the Section 3 RUAIH crosswalk maps each CHAI pillar to its RUAIH standard area
...
**RUAIH certification crosswalk.** The Joint Commission Responsible Use of AI in Healthcare (RUAIH) certification (launched June 1, 2026) organizes its requirements into five standard areas. The CHAI eight pillars map onto the five RUAIH standard areas as follows; include this crosswalk in the Section 9 export block so the intake record doubles as RUAIH certification evidence:

| RUAIH standard area | CHAI pillar(s) that supply the evidence |
|---|---|
| **1. Governance** | Pillar 1 (Organizational AI Policy) + Pillar 2 (Organizational Structure) |
| **2. Effective data management** | Pillar 6 (Responsible Data Management and Use) |
| **3. Risk and bias reduction** | Pillar 5 (Risk and Impact Assessments) + Pillar 7 (Third-Party Management) |
| **4. Monitoring, evaluating, and validating safety, effectiveness, and responsible use** | Pillar 3 (Organizational Resources) + Pillar 4 (Responsible AI Lifecycle Management) |
| **5. Transparency, education, and training** | Pillar 8 (Education, Training, and Feedback) + the patient-AI-use disclosure posture under Pillar 1 |

Note that RUAIH certifies the *organization's* responsible-use posture across its AI portfolio, not any individual tool; a single intake record is one input to the organization-level certification file, and a `🟠 HIGH` or `🔴 CRITICAL` finding in a pillar should be read as a gap in the corresponding RUAIH standard area that the organization must close before it can credibly attest at certification.
...
3. **Organizational Resources.** Is there documented budget, staffing, and technical capacity to monitor the tool through its lifecycle? For LLM-based tools, is there capacity to run periodic re-audits per the audit-class skills in this repo? For agentic-extension tools, is there capacity to apply the CHI-Bench-calibrated reviewer-cycle cadence captured in `ambient-scribe-note-audit.md` v1.5 and `prior-auth-letter-generator.md` v2.4? For community-health and safety-net deployers, apply the scaled-control tier — what is the realistic monitoring cadence given staffing?
...
- **Ambient scribe.** Cross-reference `ambient-scribe-note-audit.md` v1.5 — feed the procurement-phase consent-posture checklist, the per-encounter audit-header notification field, the long-horizon agent reliability calibration, and the vendor selection audit checklist into the intake under Pillar 6 and Pillar 7.
...
- **Federal — CMS Office of Health Technology Products (OHTP), stood up July 2026.** CMS consolidated its AI, interoperability, and digital-health functions into a new office (organized into multiple groups, including an open-source program group) to coordinate oversight and payment policy for AI-enabled and digital-health tools across CMS programs. Not itself a new obligation, but for any deployment touching Medicare or Medicaid it creates a more defined federal review interlocutor and procurement pathway; the intake should note it where the tool is reimbursed by, or exchanges data with, a CMS program.
...
- **Connecticut.** SB 5 — **signed June 2, 2026 as Public Act 26-15, the Connecticut Artificial Intelligence Responsibility and Transparency Act ("CART Act")**; one of the most comprehensive state AI laws enacted to date, with distinct obligations for employment automated-decision tools, consumer chatbots (AI-identity disclosure, crisis-referral, minor-specific provisions), frontier-model developers, generative-AI provenance, and healthcare carveouts/innovation initiatives; phased effective dates begin October 1, 2026.
- **Vermont.** HB 814 (neurological rights + AI in health services; restricts insurer AI in claim denial — signed; AI Task Force appointed), H.816 (therapy-bot ban — bars AI from diagnosing mental health conditions or creating treatment plans, and prohibits advertising AI-delivered therapeutic judgment, with unlicensed-practice exposure for licensees who delegate those decisions to AI; **signed by Governor Scott June 17, 2026** over an industry veto push — now an enacted, operative statute). For behavioral-health audio capture or any patient-facing behavioral-health surface in Vermont, treat H.816 as in force and cross-reference `behavioral-health-ai-chatbot-compliance-review.md` v1.3.
- **Rhode Island.** Three AI laws **signed June 22, 2026**: H 7349 / S 2197 (Oversight of AI Technology in Mental Health Care Act — therapy-bot ban; also prohibits AI simulation of emotional attachment/bonding/dependency, AI companions for mental-health/emotional support, and AI-assisted therapeutic communication in recorded/transcribed sessions without written consent); S 2195 / H 7350 (chatbot-safety Act — statutory self-harm crisis-referral protocol, AG annual reporting from July 1, 2027, penalties up to $15,000/day); and H 7538 (Use of AI by Healthcare Providers Notification Act — per-encounter patient notification whenever AI documents an in-person or telehealth visit, plus a mandatory clinician post-visit accuracy review). For ambient-scribe deployments, treat H 7538 as in force and cross-reference `ambient-scribe-note-audit.md` v1.5 and `patient-ai-use-disclosure-notice.md` v1.1; for patient-facing behavioral-health surfaces, treat H 7349 / S 2195 as in force and cross-reference `behavioral-health-ai-chatbot-compliance-review.md` v1.3.
...
- **Tennessee.** SB 1580 (the Tennessee Health Care AI Act) — signed April 1, 2026 and **in force effective July 1, 2026**. Prohibits any developer or deployer of an AI system from advertising or representing to the public that the system is, or is able to act as, a *qualified mental health professional* (a term defined in TN licensure law). Enforced as an unfair-or-deceptive act under the Tennessee Consumer Protection Act — up to $5,000 per violation **plus a private right of action** for affected individuals. For any patient-facing behavioral-health surface in Tennessee, treat SB 1580 as in force and cross-reference `behavioral-health-ai-chatbot-compliance-review.md` v1.3.
...
- **Regulatory fence.** Tool is re-intaked on any of: a new state law taking effect (Maryland HB 1563, Connecticut CART Act / PA 26-15 phased effective dates beginning October 1, 2026, Vermont H.816 therapy-bot ban signed June 17, 2026, Rhode Island H 7349 / S 2195 / H 7538 signed June 22, 2026), a CMS subregulatory action on the MACPAC June 2026 framework, a finalized HTI-5 rule, an FDA enforcement action on the tool class, a Joint Commission RUAIH certification standard update, a CHAI playbook update.
...
Produce a copy-paste-ready block for the AI Tool Registry, the contract file, the board AI subcommittee minutes, the Joint Commission RUAIH certification file, the AI-aware HIPAA risk-analysis matrix, and the vendor-management file. The block should include: tool identity; lifecycle stage; recommended decision; conditions and fences; renewal triggers; decommission criteria; named owners by pillar; the RUAIH five-standard crosswalk (Section 3) with the per-standard residual-risk rollup; cross-skill linkage list; multi-state regulatory mapping summary; evidence-gap remediation queue with target dates; the date of the next scheduled re-intake.
...
[Pillar 3 — Organizational Resources]
  ...
  Gap(s) identified: 0.4 FTE cannot sustain the post-deployment audit cadence the `ambient-scribe-note-audit.md` v1.5 procurement-phase + post-deployment combined cadence implies for fourteen sites
  Risk: 🟠 HIGH
...
[Pillar 6 — Responsible Data Management and Use]
  ...
  Remediation: pilot-with-fence condition — contract amendment to assert training-data opt-out; deployment of audit-header notification field per `ambient-scribe-note-audit.md` v1.5 before expansion; recording-boundary diagram update before expansion
...
This skill produces a structured intake record. It does not constitute legal advice, does not substitute for the deployer's Privacy Officer or counsel, does not substitute for the deployer's HIPAA risk analysis, does not substitute for the vendor's own attestations or red-team report, and does not substitute for the existing audit-class skills in this repo. The intake reflects the May 27, 2026 CHAI eight-pillar architecture, the Joint Commission Responsible Use of AI in Healthcare (RUAIH) certification launched June 1, 2026 (five standard areas), the NIST AI Risk Management Framework, ISO 42001, the HHS AI Strategy (April 3, 2026 risk-management deadline), and the operative state and federal AI-in-healthcare regulatory perimeter as of June 8, 2026. The deployer is responsible for refreshing the regulatory mapping at each re-intake.
...
External references: Coalition for Health AI (CHAI) governance playbooks (May 27, 2026); Joint Commission + CHAI Responsible Use of AI guidance (initial September 2025; in-depth playbooks May 27, 2026; Joint Commission Responsible Use of AI in Healthcare (RUAIH) voluntary certification launched June 1, 2026, organized around five standard areas — governance, effective data management, risk and bias reduction, monitoring/evaluating/validating, and transparency/education/training — open to non-accredited applicants); NIST AI Risk Management Framework; ISO 42001; HHS AI Strategy and April 3, 2026 risk-management deadline; HHS RFI on AI clinical care (December 2025 — closed February 23, 2026); CMS-0057-F (in force January 1, 2026); CMS-0062-P (comment window open through June 15, 2026); FDA 2026 CDS and wearables guidance (January 6, 2026); FDA QMSR / ISO 13485:2016 alignment; HTI-5 proposed rule (December 22, 2025 — comment closed February 27, 2026); MACPAC June 2026 Report Medicaid PA automation framework; CHI-Bench long-horizon healthcare workflow benchmark; ARISE State of Clinical AI Report 2026; Ontario Auditor General multi-vendor ambient-scribe procurement audit (May 13, 2026); Elsevier Clinician of the Future 2026 Nurses Edition; NHS England ambient scribing guidance (March 31, 2026); California AB 489; Texas TRAIGA; Colorado HB26-1139 / HB24-1054; Connecticut SB 5 / CART Act (Public Act 26-15, signed June 2, 2026); Vermont HB 814 (signed) / H.816 (therapy-bot ban — signed June 17, 2026; enacted and operative); Rhode Island H 7349 / S 2197 (therapy-bot ban), S 2195 / H 7350 (chatbot self-harm-safety Act), and H 7538 (Use of AI by Healthcare Providers Notification Act) — all three signed June 22, 2026; enacted and operative; Arizona 2026 AI bills vetoed by Governor Hobbs in late June 2026 (not in force); Maryland HB 1563 (effective June 1, 2026); Maryland October 1, 2025 AI utilization-management law; Georgia SB 544 (effective January 1, 2027); Tennessee SB 1580 (Tennessee Health Care AI Act — signed April 1, 2026; in force July 1, 2026; bars advertising/representing an AI system as a qualified mental health professional; enforced under the TN Consumer Protection Act with a private right of action and up to $5,000/violation); CMS Office of Health Technology Products (OHTP, stood up July 2026 to coordinate AI / interoperability / digital-health oversight and payment policy across CMS programs); Utah AI PA and Office of AI Policy posture; federal SAFE BOTs framework; OWASP 2025 LLM Top-10; 45 CFR §164.308(a)(1)(ii)(A) (HIPAA security risk analysis); 45 CFR §164.502(b) (minimum necessary); 42 CFR Part 2 (SUD-treatment records); AAN 2026 AI position statement; AMA April 22, 2026 Congressional letter; AHRQ AI in Healthcare Safety Program / PSO.
