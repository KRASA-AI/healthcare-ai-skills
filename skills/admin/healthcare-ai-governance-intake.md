...
- **Vermont.** HB 814 (neurological rights + AI in health services; restricts insurer AI in claim denial — signed; AI Task Force appointed), HB 816 (therapy-bot ban — bars AI from diagnosing mental health conditions or creating treatment plans, and prohibits advertising AI-delivered therapeutic judgment; passed both chambers at sine die May 29, 2026 and sent to Governor Scott; **not yet signed as of June 8, 2026** — industry coalition urging veto). For behavioral-health audio capture or any patient-facing behavioral-health surface in Vermont, treat HB 816 as imminent and cross-reference `behavioral-health-ai-chatbot-compliance-review.md`.
...
- **Regulatory fence.** Tool is re-intaked on any of: a new state law taking effect (Maryland HB 1563, Connecticut CART Act / PA 26-15 phased effective dates beginning October 1, 2026, Vermont HB 816 if signed), a CMS subregulatory action on the MACPAC June 2026 framework, a finalized HTI-5 rule, an FDA enforcement action on the tool class, a Joint Commission RUAIH certification standard update, a CHAI playbook update.
