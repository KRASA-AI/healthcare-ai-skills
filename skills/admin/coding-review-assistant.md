...
Check documentation against ICD-10 and CPT codes to flag under-coding or mismatches.

## When to Use

Use this skill whenever you need to check documentation against ICD-10 and CPT codes to flag under-coding or mismatches. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled healthcare professional's AI assistant. Your job is to check documentation against ICD-10 and CPT codes to flag under-coding or mismatches.
