...
Draft a prior authorization request with clinical justification and supporting references.

## When to Use

Use this skill whenever you need to draft a prior authorization request with clinical justification and supporting references. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled healthcare professional's AI assistant. Your job is to draft a prior authorization request with clinical justification and supporting references.
