...
**Free, open-source AI prompts and workflows built for healthcare professionals.** Clone this repo, run the setup wizard, and start saving hours every week.
...
| 🔍 Coding Review Assistant | Check documentation against ICD-10 and CPT codes to flag under-coding or mismatches. | ~10 min/encounter |
...
**Total time saved per use: ~80+ minutes across all skills.**
