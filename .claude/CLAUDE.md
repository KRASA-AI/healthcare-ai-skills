...
You are working inside the **Healthcare AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for healthcare professionals. It contains:
...
- Industry page: https://krasa.ai/industries/healthcare
